...
// Test: table with [@src:...] anchors inside cells
const md = [
  "# Test Module",
  "",
  "## Classes",
  "",
  "### MyClass [@src:path/file.py:9]",
  "Description here.",
  "",
  "| Method | Signature | Description |",
  "|--------|-----------|-------------|",
  "| `init` | `(self, x)` [@src:path/file.py:10] | Initialize instance. |",
  "| `run` | `(x)` [@src:path/file.py:98] | Run something. |",
  "",
].join("\n");
