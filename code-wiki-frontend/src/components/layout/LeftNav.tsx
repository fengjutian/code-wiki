import { CodeIcon, BookOpenIcon, SettingsIcon, BarChart3Icon, GitGraphIcon, ActivityIcon, GaugeIcon, GitBranchIcon, SearchIcon, AlertTriangleIcon, LightbulbIcon, DatabaseIcon } from "lucide-react";
